...
def generateSNNSyntax(fileName):
    ...
    dfPopSizeExternal = pd.read_excel(fileName,
                                      sheet_name='pop_size_neuron_type_afferent'). \
                                      dropna();
    ...
    # connection
    dfConnMat = dfConnMat.iloc[0:10,:-1];
    ...
    dfPopSizeInternal = dfPopSize.loc[0:7];
    ...
    # the SNN besides the afferent groups
    ...
    # syntax
    dfPoisson['popSizes'] = dfNeuronTypes.iloc[8:10,3].values
...
generateSNNSyntax("ca3net_04_19_21.xlsm")
